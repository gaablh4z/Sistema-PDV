    ...
    <header className="bg-white shadow-md border-b border-gray-200">
      ...
      <div className="px-6 py-4 border-b border-gray-100">
        <div className="flex items-center justify-between">
          ...
          {/* Data */}
          <div className="hidden md:block text-sm text-primary-800 font-medium bg-primary-50 px-3 py-1 rounded-full shadow-sm">
            {currentDate}
          </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative hidden md:block">
              ...
              <input
                type="text"
                placeholder="Buscar..."
                className="pl-10 pr-4 py-2 border border-primary-200 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent w-64 bg-white shadow-sm"
              />
            </div>

            {/* Notificações */}
            <button className="relative p-2 text-primary-600 hover:text-primary-800 transition-colors rounded-lg hover:bg-primary-50 shadow-sm">
              <Bell className="h-5 w-5" />
              <span className="absolute -top-1 -right-1 h-4 w-4 bg-primary-600 text-white text-xs rounded-full flex items-center justify-center shadow-sm">
                3
              </span>
            </button>
            ...
            return (
              <button
                ...
                className={`flex items-center space-x-2 px-4 py-4 border-b-2 transition-all duration-300 whitespace-nowrap ${
                  isActive
                    ? 'border-primary-700 text-primary-800 bg-primary-50 shadow-sm font-semibold'
